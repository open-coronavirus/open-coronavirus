...
export const APIS = [AuthControllerService, BluetoothLeAdvertisementControllerService, ContactControllerService, DocumentControllerService, GeolocationControllerService, HealthCenterControllerService, LeaveRequestControllerService, MeControllerService, PatientControllerService, PingControllerService, PoliceOfficerControllerService, SanitarianControllerService, TestAppointmentControllerService, TestQuestionControllerService, TestResultControllerService];
