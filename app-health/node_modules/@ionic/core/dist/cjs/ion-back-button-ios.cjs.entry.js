...
const BackButton = class {
    ...
    get backButtonIcon() {
        ...
        if (this.mode === 'ios') {
            ...
            return config.config.get('backButtonIcon', 'chevron-back');
        }
        // default md back button icon
        return config.config.get('backButtonIcon', 'arrow-back-sharp');
    }
    get backButtonText() {
